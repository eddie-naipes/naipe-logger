...
export function ConnectWithToken(arg1:string,arg2:string):Promise<api.LoginResponse>;
...
export function GetPublicConfig():Promise<api.PublicConfig>;
...
export function LegacyCredentialPurged():Promise<boolean>;
...
export function TestConnection():Promise<Array<any>>;
